...
class TooManyRequestError(object):
    ...
    def __init__(self, message=None, uuid=None):  # noqa: E501
        """TooManyRequestError - a model defined in Swagger"""  # noqa: E501
        self._message = None
        self._uuid = None
    ...
    @property
    def message(self):
        """Gets the message of this TooManyRequestError.  # noqa: E501


        :return: The message of this TooManyRequestError.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this TooManyRequestError.


        :param message: The message of this TooManyRequestError.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    @property
    def uuid(self):
        """Gets the uuid of this TooManyRequestError.  # noqa: E501


        :return: The uuid of this TooManyRequestError.  # noqa: E501
        :rtype: str
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this TooManyRequestError.


        :param uuid: The uuid of this TooManyRequestError.  # noqa: E501
        :type: str
        """
        if uuid is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TooManyRequestError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TooManyRequestError):
            return False
