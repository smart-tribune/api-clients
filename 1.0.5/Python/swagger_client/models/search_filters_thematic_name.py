...
class SearchFiltersThematicName(object):
    ...
    def __init__(self, type=None, name=None):  # noqa: E501
        """SearchFiltersThematicName - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._name = None
    ...
    @property
    def type(self):
        """Gets the type of this SearchFiltersThematicName.  # noqa: E501


        :return: The type of this SearchFiltersThematicName.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SearchFiltersThematicName.


        :param type: The type of this SearchFiltersThematicName.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def name(self):
        """Gets the name of this SearchFiltersThematicName.  # noqa: E501


        :return: The name of this SearchFiltersThematicName.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SearchFiltersThematicName.


        :param name: The name of this SearchFiltersThematicName.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchFiltersThematicName, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchFiltersThematicName):
            return False
