...
class ResponsessatisfactionsSatisfactionIdBody(object):
    ...
    def __init__(self, reason=None):  # noqa: E501
        """ResponsessatisfactionsSatisfactionIdBody - a model defined in Swagger"""  # noqa: E501
        self._reason = None
    ...
    @property
    def reason(self):
        """Gets the reason of this ResponsessatisfactionsSatisfactionIdBody.  # noqa: E501


        :return: The reason of this ResponsessatisfactionsSatisfactionIdBody.  # noqa: E501
        :rtype: int
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this ResponsessatisfactionsSatisfactionIdBody.


        :param reason: The reason of this ResponsessatisfactionsSatisfactionIdBody.  # noqa: E501
        :type: int
        """
        if reason is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponsessatisfactionsSatisfactionIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponsessatisfactionsSatisfactionIdBody):
            return False
