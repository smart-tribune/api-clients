...
class SearchFiltersOperatorsTag(object):
    ...
    def __init__(self, tag=None):  # noqa: E501
        """SearchFiltersOperatorsTag - a model defined in Swagger"""  # noqa: E501
        self._tag = None
    ...
    @property
    def tag(self):
        """Gets the tag of this SearchFiltersOperatorsTag.  # noqa: E501


        :return: The tag of this SearchFiltersOperatorsTag.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this SearchFiltersOperatorsTag.


        :param tag: The tag of this SearchFiltersOperatorsTag.  # noqa: E501
        :type: str
        """
        if tag is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchFiltersOperatorsTag, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchFiltersOperatorsTag):
            return False
