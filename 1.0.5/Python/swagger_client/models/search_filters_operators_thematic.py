...
class SearchFiltersOperatorsThematic(object):
    ...
    def __init__(self, thematic=None):  # noqa: E501
        """SearchFiltersOperatorsThematic - a model defined in Swagger"""  # noqa: E501
        self._thematic = None
    ...
    @property
    def thematic(self):
        """Gets the thematic of this SearchFiltersOperatorsThematic.  # noqa: E501


        :return: The thematic of this SearchFiltersOperatorsThematic.  # noqa: E501
        :rtype: str
        """
    ...
    def thematic(self, thematic):
        """Sets the thematic of this SearchFiltersOperatorsThematic.


        :param thematic: The thematic of this SearchFiltersOperatorsThematic.  # noqa: E501
        :type: str
        """
        if thematic is None:
            raise ValueError("Invalid value for `thematic`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchFiltersOperatorsThematic, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchFiltersOperatorsThematic):
            return False
