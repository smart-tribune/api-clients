...
class AuthenticationApi(object):
    ...
    def v1_auth_post(self, body, **kwargs):  # noqa: E501
        """Authenticate through our API  # noqa: E501

        Allow user to authenticate through our API and retrieve a JWT token that need to be used within all requests  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_auth_post(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Auth body: Authenticate user and retrieve JWT token (required)
        ...
        if kwargs.get('async_req'):
            return self.v1_auth_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_auth_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def v1_auth_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Authenticate through our API  # noqa: E501

        Allow user to authenticate through our API and retrieve a JWT token that need to be used within all requests  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_auth_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_auth_post`")  # noqa: E501
