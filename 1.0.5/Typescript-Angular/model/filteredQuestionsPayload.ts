 ...
 */
import { SearchFiltersOperatorsTag } from './searchFiltersOperatorsTag';
import { SearchFiltersOperatorsThematic } from './searchFiltersOperatorsThematic';
import { SearchFiltersTagName } from './searchFiltersTagName';
import { SearchFiltersThematicName } from './searchFiltersThematicName';
import { SearchFiltersThematicSlug } from './searchFiltersThematicSlug';

export interface FilteredQuestionsPayload { 
    channel?: FilteredQuestionsPayload.ChannelEnum;
    promoted?: boolean;
    frequent?: boolean;
    query?: string;
    useSuggester?: boolean;
    excludedQuestions?: Array<number>;
    questionSlug?: string;
    searchFilters?: Array<SearchFiltersThematicName | SearchFiltersThematicSlug | SearchFiltersTagName>;
    searchFiltersOperators?: Array<SearchFiltersOperatorsTag | SearchFiltersOperatorsThematic>;
    limit?: number;
}
export namespace FilteredQuestionsPayload {
    export type ChannelEnum = 'faq' | 'push' | 'bot';
    export const ChannelEnum = {
        Faq: 'faq' as ChannelEnum,
        Push: 'push' as ChannelEnum,
        Bot: 'bot' as ChannelEnum
    };
}