...
/**
 * SearchFiltersOperatorsThematic Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SearchFiltersOperatorsThematic implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'searchFiltersOperatorsThematic';
    ...
    {
        $this->container['thematic'] = isset($data['thematic']) ? $data['thematic'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['thematic'] === null) {
            $invalidProperties[] = "'thematic' can't be null";
        }
    ...
    {
        return $this->container['thematic'];
    }

    /**
     * Sets thematic
     *
     * @param string $thematic thematic
     *
     * @return $this
     */
    public function setThematic($thematic)
    {
        $this->container['thematic'] = $thematic;
