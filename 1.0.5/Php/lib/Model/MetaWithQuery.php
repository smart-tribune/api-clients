...
/**
 * MetaWithQuery Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MetaWithQuery implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MetaWithQuery';
...
'executed_query' => 'setExecutedQuery'    ];
...
'executed_query' => 'getExecutedQuery'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['original_query'] = isset($data['original_query']) ? $data['original_query'] : null;
        $this->container['executed_query'] = isset($data['executed_query']) ? $data['executed_query'] : null;
    }
     ...
     * Sets original_query
     *
     * @param string $original_query original_query
     *
     * @return $this
     */
    ...
    {
        return $this->container['executed_query'];
    }

    /**
     * Sets executed_query
     *
     * @param string $executed_query executed_query
     *
     * @return $this
     */
    public function setExecutedQuery($executed_query)
    {
        $this->container['executed_query'] = $executed_query;
