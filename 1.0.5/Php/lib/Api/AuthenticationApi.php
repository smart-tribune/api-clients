...
class AuthenticationApi
{
    ...
    /**
     * Operation v1AuthPost
     *
     * Authenticate through our API
     *
     * @param  \Swagger\Client\Model\Auth $body Authenticate user and retrieve JWT token (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse200
     */
    public function v1AuthPost($body)
    {
        list($response) = $this->v1AuthPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation v1AuthPostWithHttpInfo
     *
     * Authenticate through our API
     *
     * @param  \Swagger\Client\Model\Auth $body Authenticate user and retrieve JWT token (required)
     ...
     */
    public function v1AuthPostWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->v1AuthPostRequest($body);
     ...
     */
    public function v1AuthPostAsync($body)
    {
        return $this->v1AuthPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1AuthPostAsyncWithHttpInfo
     *
     * Authenticate through our API
     *
     * @param  \Swagger\Client\Model\Auth $body Authenticate user and retrieve JWT token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1AuthPostAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->v1AuthPostRequest($body);
    ...
    /**
     * Create request for operation 'v1AuthPost'
     *
     * @param  \Swagger\Client\Model\Auth $body Authenticate user and retrieve JWT token (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function v1AuthPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling v1AuthPost'
            );
        }
