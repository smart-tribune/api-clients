 ...
 * @param limit 
 */
data class FilteredThematicsPayload (

    val channel: FilteredThematicsPayload.Channel? = null,
    ...
    val searchFilters: kotlin.Array<AnyOfFilteredThematicsPayloadSearchFiltersItems>? = null,
