 ...
 * @param questionSlug 
 * @param searchFilters 
 * @param searchFiltersOperators 
 * @param limit 
 */
data class FilteredQuestionsPayload (

    val channel: FilteredQuestionsPayload.Channel? = null,
    val promoted: kotlin.Boolean? = null,
    val frequent: kotlin.Boolean? = null,
    val query: kotlin.String? = null,
    val useSuggester: kotlin.Boolean? = null,
    val excludedQuestions: kotlin.Array<kotlin.Int>? = null,
    val questionSlug: kotlin.String? = null,
    val searchFilters: kotlin.Array<AnyOfFilteredQuestionsPayloadSearchFiltersItems>? = null,
    val searchFiltersOperators: kotlin.Array<AnyOfFilteredQuestionsPayloadSearchFiltersOperatorsItems>? = null,
