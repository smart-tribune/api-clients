...
import io.swagger.client.models.FilteredQuestionsData
import io.swagger.client.models.MetaWithQuery
...
data class InlineResponse2001 (
    ...
    val meta: MetaWithQuery? = null,
    val `data`: kotlin.Array<FilteredQuestionsData>? = null
) {
}