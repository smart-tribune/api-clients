...
// APIClient manages communication with the Smart Tribune V2 API API v1.0.5
...
type APIClient struct {
	...
	FilteredAPIApi *FilteredAPIApiService

	GenericAPIApi *GenericAPIApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.FilteredAPIApi = (*FilteredAPIApiService)(&c.common)
	c.GenericAPIApi = (*GenericAPIApiService)(&c.common)
