...
type FilteredQuestionsPayload struct {
	Channel string `json:"channel,omitempty"`
	Promoted bool `json:"promoted,omitempty"`
	Frequent bool `json:"frequent,omitempty"`
	Query string `json:"query,omitempty"`
	UseSuggester bool `json:"useSuggester,omitempty"`
	ExcludedQuestions []int32 `json:"excludedQuestions,omitempty"`
	QuestionSlug string `json:"questionSlug,omitempty"`
	SearchFilters []AnyOfFilteredQuestionsPayloadSearchFiltersItems `json:"searchFilters,omitempty"`
	SearchFiltersOperators []AnyOfFilteredQuestionsPayloadSearchFiltersOperatorsItems `json:"searchFiltersOperators,omitempty"`
